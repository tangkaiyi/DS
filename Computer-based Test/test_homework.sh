...
TOTAL_TASKS=9               # 總共有幾個程式
CXX="g++"                   # 編譯器
CXXFLAGS="-O2 -std=c++11"   # 編譯參數

# 設定每個任務的時間限制
TIME_LIMITS=("4.0s" "4.0s" "8.0s" "4.0s" "8.0s" "8.0s" "8.0s" "8.0s" "8.0s")

# 設定每個任務的配分
TASK_SCORES=(10 10 10 10 10 10 10 10 20)
# =========================================
...
for i in $(seq 1 $TOTAL_TASKS); do
    SRC_FILE="${i}.cpp"
    EXE_FILE="Computer-based Test"     # 直接存放在當前目錄
